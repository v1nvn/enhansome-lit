...
[Lit](https://github.com/lit/lit) ⭐ 21,237 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-16 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,237 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-16
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,237 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-16
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 78,225 | 🐛 619 | 🌐 TypeScript | 📅 2026-02-19 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 78,225 | 🐛 619 | 🌐 TypeScript | 📅 2026-02-19 - Lit and TypeScript based template preset for Vite.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-18 - Simple starter web component written in TypeScript using Lit.
...
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,721 | 🐛 289 | 🌐 TypeScript | 📅 2026-02-19 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,488 | 🐛 226 | 🌐 TypeScript | 📅 2026-02-19 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 873 | 🐛 71 | 🌐 TypeScript | 📅 2026-02-18 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 554 | 🐛 935 | 🌐 JavaScript | 📅 2026-02-18 - A set of high-quality web components for business web applications.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 7,908 | 🐛 118 | 🌐 TypeScript | 📅 2026-02-18 - A web component for rendering interactive 3D models.
...
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 5,542 | 🐛 183 | 🌐 TypeScript | 📅 2026-02-17 - Block based editor, designed for general-purpose collaborative applications.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 200 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-18 - Web component for rendering responsive images.
...
* [Ruby2JS](https://github.com/ruby2js/ruby2js) ⭐ 478 | 🐛 0 | 🌐 Ruby | 📅 2026-02-18 - Minimal yet extensible Ruby to JavaScript conversion.
...
* [htm](https://github.com/developit/htm) ⭐ 8,997 | 🐛 49 | 🌐 JavaScript | 📅 2024-02-01 - Hyperscript Tagged Markup: JSX alternative using standard tagged templates, with compiler support.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 438,409 | 🐛 71 | 📅 2026-01-28 list!**
