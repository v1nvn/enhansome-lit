...
[Lit](https://github.com/lit/lit) ⭐ 21,213 | 🐛 650 | 🌐 TypeScript | 📅 2026-02-03 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,213 | 🐛 650 | 🌐 TypeScript | 📅 2026-02-03
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,213 | 🐛 650 | 🌐 TypeScript | 📅 2026-02-03
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 78,077 | 🐛 618 | 🌐 TypeScript | 📅 2026-02-10 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 78,077 | 🐛 618 | 🌐 TypeScript | 📅 2026-02-10 - Lit and TypeScript based template preset for Vite.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-10 - Simple starter web component written in TypeScript using Lit.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 63 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-10 - Build Web Components with functional programming using Lit.
...
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,930 | 🐛 161 | 🌐 JavaScript | 📅 2026-02-10 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,719 | 🐛 280 | 🌐 TypeScript | 📅 2026-02-11 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,485 | 🐛 227 | 🌐 TypeScript | 📅 2026-02-11 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 853 | 🐛 83 | 🌐 TypeScript | 📅 2026-02-11 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 552 | 🐛 939 | 🌐 JavaScript | 📅 2026-02-10 - A set of high-quality web components for business web applications.
...
* [Wired Elements](https://github.com/rough-stuff/wired-elements) ⭐ 10,754 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Collection of elements that appear hand drawn.
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,377 | 🐛 172 | 🌐 TypeScript | 📅 2026-02-08 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [Web Components for TEI Publisher](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 53 | 🌐 JavaScript | 📅 2026-01-26 - Web components used by TEI Publisher and apps generated by it.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 7,898 | 🐛 118 | 🌐 TypeScript | 📅 2026-02-10 - A web component for rendering interactive 3D models.
...
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 5,530 | 🐛 183 | 🌐 TypeScript | 📅 2026-02-02 - Block based editor, designed for general-purpose collaborative applications.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 199 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-11 - Web component for rendering responsive images.
...
* [`<stl-part-viewer>`](https://github.com/justinribeiro/stl-part-viewer) ⭐ 21 | 🐛 5 | 🌐 JavaScript | 📅 2023-10-12 - LitElement web component that utilizes Three.js to display an STL model file.
...
* [Ruby2JS](https://github.com/ruby2js/ruby2js) ⭐ 476 | 🐛 2 | 🌐 Ruby | 📅 2026-02-11 - Minimal yet extensible Ruby to JavaScript conversion.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 436,589 | 🐛 68 | 📅 2026-01-28 list!**
