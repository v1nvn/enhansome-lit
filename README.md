...
[Lit](https://github.com/lit/lit) ⭐ 21,343 | 🐛 659 | 🌐 TypeScript | 📅 2026-03-20 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,343 | 🐛 659 | 🌐 TypeScript | 📅 2026-03-20
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,343 | 🐛 659 | 🌐 TypeScript | 📅 2026-03-20
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 79,250 | 🐛 674 | 🌐 TypeScript | 📅 2026-03-20 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 79,250 | 🐛 674 | 🌐 TypeScript | 📅 2026-03-20 - Lit and TypeScript based template preset for Vite.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-18 - Simple starter web component written in TypeScript using Lit.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 63 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-20 - Build Web Components with functional programming using Lit.
...
* [`pure-lit`](https://github.com/MatthiasKainer/pure-lit) ⭐ 25 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-20 - Register your Lit elements as pure functions.
...
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,936 | 🐛 170 | 🌐 JavaScript | 📅 2026-03-19 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,728 | 🐛 289 | 🌐 TypeScript | 📅 2026-03-21 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,494 | 🐛 233 | 🌐 TypeScript | 📅 2026-03-20 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 936 | 🐛 72 | 🌐 TypeScript | 📅 2026-03-20 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 556 | 🐛 943 | 🌐 JavaScript | 📅 2026-03-20 - A set of high-quality web components for business web applications.
...
* [Wired Elements](https://github.com/rough-stuff/wired-elements) ⭐ 10,764 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Collection of elements that appear hand drawn.
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,435 | 🐛 160 | 🌐 TypeScript | 📅 2026-03-16 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [ESP Web Tools](https://github.com/esphome/esp-web-tools) ⭐ 630 | 🐛 58 | 🌐 TypeScript | 📅 2026-03-16 - Allow flashing ESPHome or other ESP-based firmwares via the browser.
...
* [Blackstone UI](https://github.com/kjantzer/bui) ⭐ 109 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-19 - Web components for creating interfaces built with lit-html and LitElement.
...
* [M3E](https://github.com/matraic/m3e) ⭐ 81 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-21 - Web Components implementing Material 3 Expressive.
...
* [Web Components for TEI Publisher](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 53 | 🌐 JavaScript | 📅 2026-03-18 - Web components used by TEI Publisher and apps generated by it.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 7,963 | 🐛 114 | 🌐 TypeScript | 📅 2026-03-19 - A web component for rendering interactive 3D models.
* [`<light-gallery>`](https://github.com/sachinchoolur/lightGallery/tree/master/lightgallery-lit) ⭐ 6,992 | 🐛 62 | 🌐 TypeScript | 📅 2026-03-17 - Full featured JavaScript image and video gallery for Lit.
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 5,710 | 🐛 191 | 🌐 TypeScript | 📅 2026-03-13 - Block based editor, designed for general-purpose collaborative applications.
* [`<rapi-doc>`](https://github.com/mrin9/RapiDoc) ⭐ 1,885 | 🐛 132 | 🌐 JavaScript | 📅 2026-02-11 - Web Component to view OpenAPI 3.0 & Swagger 2.0 Spec.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 200 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-20 - Web component for rendering responsive images.
...
* [`<helium-animated-pages>`](https://github.com/alangdm/helium-animated-pages) ⭐ 16 | 🐛 16 | 🌐 JavaScript | 📅 2026-03-13 - Web component for creating CSS animations built with Lit.
...
* [Web Component DevTools](https://github.com/Matsuuu/web-component-devtools) ⭐ 152 | 🐛 20 | 🌐 TypeScript | 📅 2025-12-08 - Browser extension for developers working with Web Components.
...
* [Ruby2JS](https://github.com/ruby2js/ruby2js) ⭐ 482 | 🐛 8 | 🌐 Ruby | 📅 2026-03-21 - Minimal yet extensible Ruby to JavaScript conversion.
...
* [htm](https://github.com/developit/htm) ⭐ 9,010 | 🐛 49 | 🌐 JavaScript | 📅 2024-02-01 - Hyperscript Tagged Markup: JSX alternative using standard tagged templates, with compiler support.
...
* [lit-ntml](https://github.com/motss/lit-ntml) ⭐ 81 | 🐛 4 | 🌐 TypeScript | 📅 2023-06-06 - Lightweight and modern templating for SSR in Node.js, inspired by lit-html.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 447,390 | 🐛 88 | 📅 2026-03-09 list!**
