...
[Lit](https://github.com/lit/lit) ⭐ 21,241 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-19 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,241 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-19
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,241 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-19
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 78,296 | 🐛 620 | 🌐 TypeScript | 📅 2026-02-20 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 78,296 | 🐛 620 | 🌐 TypeScript | 📅 2026-02-20 - Lit and TypeScript based template preset for Vite.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-19 - Simple starter web component written in TypeScript using Lit.
...
* [`ullr`](https://github.com/aggre/ullr) ⭐ 63 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-17 - Build Web Components with functional programming using Lit.
...
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,930 | 🐛 160 | 🌐 JavaScript | 📅 2026-02-18 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,721 | 🐛 292 | 🌐 TypeScript | 📅 2026-02-20 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,488 | 🐛 225 | 🌐 TypeScript | 📅 2026-02-20 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 874 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-19 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 554 | 🐛 935 | 🌐 JavaScript | 📅 2026-02-19 - A set of high-quality web components for business web applications.
...
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,389 | 🐛 172 | 🌐 TypeScript | 📅 2026-02-15 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [ESP Web Tools](https://github.com/esphome/esp-web-tools) ⭐ 621 | 🐛 53 | 🌐 TypeScript | 📅 2026-02-19 - Allow flashing ESPHome or other ESP-based firmwares via the browser.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 7,911 | 🐛 118 | 🌐 TypeScript | 📅 2026-02-19 - A web component for rendering interactive 3D models.
...
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 5,544 | 🐛 184 | 🌐 TypeScript | 📅 2026-02-17 - Block based editor, designed for general-purpose collaborative applications.
...
* [Ruby2JS](https://github.com/ruby2js/ruby2js) ⭐ 478 | 🐛 2 | 🌐 Ruby | 📅 2026-02-20 - Minimal yet extensible Ruby to JavaScript conversion.
...
* [htm](https://github.com/developit/htm) ⭐ 9,000 | 🐛 49 | 🌐 JavaScript | 📅 2024-02-01 - Hyperscript Tagged Markup: JSX alternative using standard tagged templates, with compiler support.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 438,708 | 🐛 70 | 📅 2026-01-28 list!**
