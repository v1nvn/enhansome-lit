...
[Lit](https://github.com/lit/lit) ⭐ 21,231 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-16 — a simple library for building fast, lightweight web components.
...
* [GitHub](https://github.com/lit/lit) ⭐ 21,231 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-16
* [GitHub Discussions](https://github.com/lit/lit/discussions) ⭐ 21,231 | 🐛 658 | 🌐 TypeScript | 📅 2026-02-16
...
* [Vite Lit Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit) ⭐ 78,167 | 🐛 617 | 🌐 TypeScript | 📅 2026-02-18 - Lit based template preset for Vite.
* [Vite Lit TS Starter](https://github.com/vitejs/vite/tree/main/packages/create-vite/template-lit-ts) ⭐ 78,167 | 🐛 617 | 🌐 TypeScript | 📅 2026-02-18 - Lit and TypeScript based template preset for Vite.
...
* [hello-web-components](https://github.com/fernandopasik/hello-web-components) ⭐ 31 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-17 - Simple starter web component written in TypeScript using Lit.
...
* [Lion](https://github.com/ing-bank/lion) ⭐ 1,930 | 🐛 162 | 🌐 JavaScript | 📅 2026-02-17 - Highly performant, accessible and flexible Web Components.
* [UI5 Web Components](https://github.com/SAP/ui5-webcomponents) ⭐ 1,721 | 🐛 284 | 🌐 TypeScript | 📅 2026-02-18 - Enterprise-flavored sugar on top of native APIs!
* [Spectrum Web Components](https://github.com/adobe/spectrum-web-components) ⭐ 1,488 | 🐛 224 | 🌐 TypeScript | 📅 2026-02-18 - Adobe Spectrum design language implementation built with LitElement.
* [Web Awesome](https://github.com/shoelace-style/webawesome) ⭐ 870 | 🐛 75 | 🌐 TypeScript | 📅 2026-02-18 - The open source library of web components from Font Awesome
* [Vaadin web components](https://github.com/vaadin/web-components) ⭐ 554 | 🐛 936 | 🌐 JavaScript | 📅 2026-02-17 - A set of high-quality web components for business web applications.
...
* [Wired Elements](https://github.com/rough-stuff/wired-elements) ⭐ 10,756 | 🐛 35 | 🌐 TypeScript | 📅 2023-10-07 - Collection of elements that appear hand drawn.
* [Vidstack Elements](https://github.com/vidstack/vds-elements) ⭐ 3,388 | 🐛 172 | 🌐 TypeScript | 📅 2026-02-15 - Spec-compliant customizable, extensible, accessible and universal media elements.
...
* [ESP Web Tools](https://github.com/esphome/esp-web-tools) ⭐ 621 | 🐛 52 | 🌐 TypeScript | 📅 2026-02-13 - Allow flashing ESPHome or other ESP-based firmwares via the browser.
...
* [Web Components for TEI Publisher](https://github.com/eeditiones/tei-publisher-components) ⭐ 18 | 🐛 53 | 🌐 JavaScript | 📅 2026-02-17 - Web components used by TEI Publisher and apps generated by it.
...
* [`<model-viewer>`](https://github.com/GoogleWebComponents/model-viewer) ⭐ 7,905 | 🐛 118 | 🌐 TypeScript | 📅 2026-02-18 - A web component for rendering interactive 3D models.
...
* [`<editor-container>`](https://github.com/toeverything/blocksuite) ⭐ 5,538 | 🐛 183 | 🌐 TypeScript | 📅 2026-02-17 - Block based editor, designed for general-purpose collaborative applications.
...
* [`<responsive-image>`](https://github.com/simonihmig/responsive-image) ⭐ 199 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-18 - Web component for rendering responsive images.
...
* [Ruby2JS](https://github.com/ruby2js/ruby2js) ⭐ 478 | 🐛 3 | 🌐 Ruby | 📅 2026-02-18 - Minimal yet extensible Ruby to JavaScript conversion.
...
* [htm](https://github.com/developit/htm) ⭐ 8,994 | 🐛 49 | 🌐 JavaScript | 📅 2024-02-01 - Hyperscript Tagged Markup: JSX alternative using standard tagged templates, with compiler support.
...
**If you want more awesome resources, check the [awesome](https://github.com/sindresorhus/awesome) ⭐ 438,155 | 🐛 70 | 📅 2026-01-28 list!**
